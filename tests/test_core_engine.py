#!/usr/bin/env python3
"""
Test Script for Core Engine Integration

This script tests the integration of all core modules to ensure they work together
correctly. It validates the LLM engine, name parser, data processor, and uncertainty
...
def test_sample_data_processing(data_processor):
    ...
    try:
        ...
        survey_result = data_processor.process_survey_data(sample_data, location_filter='Dublin')
        print(f"  ✅ Survey processing completed: {len(survey_result)} records")
        
        # Test contact export processing
        export_result = data_processor.process_contact_export_data(sample_data)
...
def main():
    """Main test function"""
    print("🚀 Starting Core Engine Integration Tests")
    print("=" * 50)
    ...
    processing_success = test_sample_data_processing(data_processor)
    if not processing_success:
        print("❌ Sample data processing test failed.")
        return False
    ...
    print("\n" + "=" * 50)
    print("🎉 All Core Engine Integration Tests Passed!")
    ...
    print("✅ Sample data processing: PASSED")
    print("✅ Uncertainty detection: PASSED")
    print("\n🚀 Core Engine is ready for use!")
